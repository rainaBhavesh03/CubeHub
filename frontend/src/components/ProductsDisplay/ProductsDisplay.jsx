    ...
    return (
        <div className="productsdisplay">
            {products.map((product) => (
                <div key={product.id} className={`productsdisplay-item ${fromSearch ? "productsdisplay-item-fromSearch" : "productsdisplay-item-notFromSearch"}`}>
                    <div className="productsdisplay-item-container">
                        <Link className="productsdisplay-link" to={`/product/${encodeURIComponent(product.id)}`} state={{currProduct: product}}  >
